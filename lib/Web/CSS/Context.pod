...
L<Web::CSS::Context> object, an instance of subclass of
L<Web::CSS::Context>, or any object which implements methods supported
by the L<Web::CSS::Context> class.  Anyway, it must behave as
documented here.
