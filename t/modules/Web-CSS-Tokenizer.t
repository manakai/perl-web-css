...
for my $test (
  ...
  [['-\\'] => ['2;css:escape:broken', [1, MINUS_TOKEN], Delim(2,'\\')]],
  [[" \x0C"] => [[1, S_TOKEN]]],
  ...
  [['#'] => [Delim(1,'#')]],
  [['#\\'] => ['2;css:escape:broken', Delim(1,'#'), Delim(2,'\\')]],
  [['#\\x'] => [[1, HASH_TOKEN, 'x', 'id']]],
  [['#-\\'] => ['3;css:escape:broken', [1, HASH_TOKEN, '-', ''], Delim(3,'\\')]],
  [['#--'] => [[1, HASH_TOKEN, '--', '']]],
  [['#-\\-'] => [[1, HASH_TOKEN, '--', 'id']]],
  [['#-a'] => [[1, HASH_TOKEN, '-a', 'id']]],
  [['#-\\z'] => [[1, HASH_TOKEN, '-z', 'id']]],
  ...
  [['-a'] => [[1, IDENT_TOKEN, '-a']]],
  [['-\\'] => ['2;css:escape:broken', [1, MINUS_TOKEN], [2, DELIM_TOKEN, '\\']]],
