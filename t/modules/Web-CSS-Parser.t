...
for my $test (
  ...
  {in => 'hoge{displAy: -moz-iniTial }',
   out => [SS [1], S(0=>1, 'hoge', ['display'], {display => K 'initial'}, {})],
   errors => ['1;15;m;css:obsolete;-moz-initial;']},
  {in => '@media{}',
   out => [SS [1], MEDIA(0=>1=>[], '')]},
  {in => '@media{',
   out => [SS [1], MEDIA(0=>1=>[], '')],
  ...
  {in => 'p{background-position:top}',
   out => [SS [1], S(0=>1, 'p',
                     ...
                     {background_position_x => ['PERCENTAGE', 50],
  ...
  {in => 'p{background-position:top;background-position:1px 2px}',
   out => [SS [1], S(0=>1, 'p',
                     ['background_position_x', 'background_position_y'],
                     {background_position_x => ['LENGTH', 1, 'px'],
                      background_position_y => ['LENGTH', 2, 'px']},
                     {})]},
  ...
  {in => 'p{background-position:inherit;background-position-x:12px}',
   out => [SS [1], S(0=>1, 'p',
                     ...
                     {background_position_x => ['LENGTH', 12, 'px'],
                      background_position_y => ['KEYWORD', 'inherit']},
                     {})]},
...
for my $test (
  ...
  {in => 'background-POSITIon:left;background-position-x:12px',
   out => {prop_keys => ['background_position_y', 'background_position_x'],
           prop_values => {background_position_x => ['LENGTH', 12, 'px'],
...
for my $test (
  ...
  {in => "", in_charset => 'UTF-16', out => {rules => [SS []], input_encoding => 'utf-16le'}},
  ...
  {in => qq[\@charset "EUC-j\\p";], out => {rules => [SS [1], CHARSET(0=>1, 'EUC-jp')], input_encoding => 'utf-8'}, errors => []},
  {in => qq[\@charset "u\\tf-8";], out => {rules => [SS [1], CHARSET(0=>1, 'utf-8')], input_encoding => 'utf-8'}, errors => []},
  {in => qq[\@charset "EUC-j\\p";], in_charset => 'iso-2022-JP', out => {rules => [SS [1], CHARSET(0=>1, 'EUC-jp')], input_encoding => 'iso-2022-jp'}, errors => []},
  ...
  {in => qq[\@CHARSET "EUC-jp";], out => {rules => [SS [1], CHARSET(0=>1, 'EUC-jp')], input_encoding => 'utf-8'}, errors => []},
  {in => qq[\@charset 'EUC-jp';], out => {rules => [SS [1], CHARSET(0=>1, 'EUC-jp')], input_encoding => 'utf-8'}, errors => []},
  {in => qq[\@charset"EUC-jp";], out => {rules => [SS [1], CHARSET(0=>1, 'EUC-jp')], input_encoding => 'utf-8'}, errors => []},
  {in => qq[ \@charset "EUC-jp";], out => {rules => [SS [1], CHARSET(0=>1, 'EUC-jp')], input_encoding => 'utf-8'}, errors => []},
  {in => qq[\@char\\set "EUC-jp";], out => {rules => [SS [1], CHARSET(0=>1, 'EUC-jp')], input_encoding => 'utf-8'}, errors => []},
  {in => qq[\@charset "EUC-jp"], out => {rules => [SS [1], CHARSET(0=>1, 'EUC-jp')], input_encoding => 'utf-8'}, errors => ['1;18;w;css:at-rule:eof;;']},
